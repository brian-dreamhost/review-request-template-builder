      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
        {SCENARIOS.map((scenario) => (
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 text-left min-h-[44px] cursor-pointer focus:outline-none focus:ring-2 focus:ring-azure focus:ring-offset-2 focus:ring-offset-abyss ${
              selected === scenario.id
                ? 'bg-azure text-white'
                : 'bg-oblivion text-galactic hover:text-white border border-metal/20 hover:border-metal/40'
            }`}
          >
            <span className="shrink-0">{iconMap[scenario.icon]}</span>
