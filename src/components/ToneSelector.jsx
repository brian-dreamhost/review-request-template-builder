      ...
      <div className="flex flex-wrap gap-2">
        {TONES.map((tone) => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 min-h-[44px] cursor-pointer focus:outline-none focus:ring-2 focus:ring-azure focus:ring-offset-2 focus:ring-offset-abyss ${
              selected === tone.id
                ? 'bg-azure text-white'
